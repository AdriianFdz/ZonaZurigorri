            ...
            <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
                ...
                <div className="hidden lg:flex items-center gap-6">
                    <ul className="flex gap-3">
                        ...
                        <NavLink href="/validador">{t('nav.validator')}</NavLink>
                        <NavLink href="/favoritos">{t('nav.favorites')}</NavLink>
                        <NavLink href="/noticias">{t('nav.news')}</NavLink>
                    </ul>
                ...
                <div className="lg:hidden fixed inset-0 top-[68px] bg-burdeos-dark z-40 overflow-y-auto">
                    <div className="flex flex-col p-6 space-y-4">
                        <ul className="flex flex-col gap-2">
                            <li onClick={() => setShowMobileMenu(false)}><NavLink href="/">{t('nav.home')}</NavLink></li>
                            <li onClick={() => setShowMobileMenu(false)}><NavLink href="/validador">{t('nav.validator')}</NavLink></li>
                            <li onClick={() => setShowMobileMenu(false)}><NavLink href="/favoritos">{t('nav.favorites')}</NavLink></li>
                            <li onClick={() => setShowMobileMenu(false)}><NavLink href="/noticias">{t('nav.news')}</NavLink></li>
                        </ul>
            ...
            {showLoginModal && (
                <div className="fixed inset-0 backdrop-blur-md bg-black/40 flex items-center justify-center z-100 p-4" onClick={() => setShowLoginModal(false)}>
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 sm:p-8 relative" onClick={(e) => e.stopPropagation()}>
                        ...
                        <h2 className="text-3xl font-bold text-burdeos-dark mb-2">{t('login.welcome')}</h2>
